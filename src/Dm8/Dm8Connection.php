...
use PDOStatement;
use Throwable;
use Duorenwei\LaravelDm8\Dm8\PDO\DmDriver;
use Duorenwei\LaravelDm8\Dm8\Query\Grammars\DmGrammar as QueryGrammar;
use Duorenwei\LaravelDm8\Dm8\Query\DmBuilder as QueryBuilder;
use Duorenwei\LaravelDm8\Dm8\Query\Processors\DmProcessor as Processor;
use Duorenwei\LaravelDm8\Dm8\Schema\Grammars\DmGrammar as SchemaGrammar;
use Duorenwei\LaravelDm8\Dm8\Schema\DmBuilder as SchemaBuilder;
use Duorenwei\LaravelDm8\Dm8\Schema\Sequence;
use Duorenwei\LaravelDm8\Dm8\Schema\Trigger;
use Duorenwei\LaravelDm8\PDO\Dm8\Statement;
...
class Dm8Connection extends Connection
{
    ...
    /**
     * @var \Duorenwei\LaravelDm8\Dm8\Schema\Sequence
     */
    protected $sequence;

    /**
     * @var \Duorenwei\LaravelDm8\Dm8\Schema\Trigger
     */
    protected $trigger;
     ...
     * Get sequence class.
     *
     * @return \Duorenwei\LaravelDm8\Dm8\Schema\Sequence
     */
     ...
     * Set sequence class.
     *
     * @param  \Duorenwei\LaravelDm8\Dm8\Schema\Sequence  $sequence
     * @return \Duorenwei\LaravelDm8\Dm8\Schema\Sequence
     */
     ...
     *
     * @param  \Duorenwei\LaravelDm8\Dm8\Schema\Trigger  $trigger
     * @return \Duorenwei\LaravelDm8\Dm8\Schema\Trigger
     */
     ...
     * Get doctrine driver.
     *
     * @return \Doctrine\DBAL\Driver\OCI8\Driver|\Duorenwei\LaravelDm8\Dm8\PDO\DmDriver
     */
     ...
     *
     * @return \Illuminate\Database\Grammar|\Duorenwei\LaravelDm8\Dm8\Query\Grammars\DmGrammar
     */
     ...
     *
     * @param  \Illuminate\Database\Grammar|\Duorenwei\LaravelDm8\Dm8\Query\Grammars\DmGrammar|\Duorenwei\LaravelDm8\Dm8\Schema\Grammars\DmGrammar  $grammar
     ...
     *
     * @return \Illuminate\Database\Grammar|\Duorenwei\LaravelDm8\Dm8\Schema\Grammars\DmGrammar
     */
     ...
     *
     * @return \Duorenwei\LaravelDm8\Dm8\Query\Processors\DmProcessor
     */
    ...
    /**
     * Execute a select query and return the first row in a DM compatible way.
     *
     * @param  string  $query
     * @param  array  $bindings
    ...
    public function selectOne($query, $bindings = [], $useReadPdo = true)
    {
        if (is_string($query) && strpos($query, 'select * from (select') !== false) {
            $query = preg_replace(
                '/select \* from \((select .*?)\) where rownum = 1/is',
                '$1 and rownum = 1',
                $query
            );
        }
