...
namespace Duorenwei\LaravelDm8\Dm8\Eloquent;

use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Query\Builder as IlluminateQueryBuilder;
use Duorenwei\LaravelDm8\Dm8\Dm8Connection;
use Duorenwei\LaravelDm8\Dm8\Query\Grammars\DmGrammar;
...
class DmEloquent extends Model
{
     ...
     *
     * @return \Illuminate\Database\Query\Builder|\Duorenwei\LaravelDm8\Dm8\Query\DmBuilder
     */
